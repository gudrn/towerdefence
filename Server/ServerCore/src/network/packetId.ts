...
export enum ePacketId {
  ...
  C2G_SkillRequest = 509,
  G2B_SkillRequest = 510,
  B2G_SkillResponse = 511,
  G2C_SkillResponse = 512,
  B2G_UseSkillNotification = 513,
  G2C_UseSkillNotification = 514,
  B2G_MonsterBuffNotification = 515,
  G2C_MonsterBuffNotification = 516,
  B2G_TowerBuffNotification = 517,
  G2C_TowerBuffNotification = 518,
  B2G_AddCard = 519,
  G2C_AddCard = 520,
