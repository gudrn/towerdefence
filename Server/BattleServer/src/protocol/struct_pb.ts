...
export const file_struct: GenFile = /*@__PURE__*/
  fileDesc("", [file_enum]);
...
export type GamePlayerData = Message<"Protocol.GamePlayerData"> & {
  ...
  /**
   * @generated from field: int32 coolDown = 4;
   */
  coolDown: number;
};
