...
//   enqueue(pos: { x: number; y: number; }, priority: number) {
//     this.elements.push({ pos, priority }); // {pos, priority} 객체 추가
//     this.elements.sort((a: { priority: number; }, b: { priority: number; }) => a.priority - b.priority); // 우선순위 기준 정렬
//   }
...
// export function aStar(start: { x: any; y: any; }, goal: { x: any; y: any; }, grid: any, obstacles: any, size: any) {
...
//     @param {Vec2} goal - 목표 지점 (객체 {x, y} 형태)
//     **/
// function heuristic(node: { x: any; y: any; }, goal: { x: any; y: any; }) {
...
// function distance(nodeA: { x: number; y: number; }, nodeB: { x: any; y: any; }) {
...
// function getNeighbors(node: { x: number; y: number; }, grid: any, obstacles: any, size: any) {
...
// function isInGrid(node: { x: any; y: any; }, grid: { width: number; height: number; }, size: number) {
...
// function isObstacle(node: { x: any; y: any; }, obstacles: any[], size: number) {
...
//  * */
// function reconstructPath(cameFrom: { [x: string]: any; }, current: { x: any; y: any; }) {
